    ...
    questions: [
      {
        ...
        answerEs: 'Me interesa Fever porque combina tecnología, datos y negocio de una forma muy directa. En mis experiencias he trabajado cerca de la parte de negocio y he visto cómo, especialmente con la llegada de la inteligencia artificial, estas áreas están ganando mucha más capacidad para descubrir nuevas herramientas, automatizar tareas, optimizar procesos y trabajar más cerca de IT. Antes muchas mejoras dependían de procesos más manuales o de capacidades técnicas muy separadas del negocio; ahora veo que esa frontera se está reduciendo muchísimo. Para mí, haber vivido esa evolución de cerca ha sido clave para entender hacia dónde quiero desarrollar mi carrera. Fever me parece una oportunidad muy buena para seguir formándome precisamente en esa intersección entre Growth, datos, tecnología y decisiones de negocio con impacto real.',
        answerEn: 'I am interested in Fever because it combines technology, data and business in a very direct way. In my previous experience, I have worked close to the business side and I have seen how, especially with the rise of AI, these teams are gaining much more power to discover new tools, automate tasks, optimise processes and work more closely with IT. In the past, many improvements depended on more manual processes or technical capabilities that were quite separate from the business. Now that gap is becoming much smaller. Seeing that evolution first-hand has been important for me because it helped me understand where I want to develop my career. Fever feels like a very strong opportunity to keep growing exactly at that intersection of Growth, data, technology and business decision-making.'
      },
      {
      ...
      },
      {
        ...
        answerEs: 'No lo veo como alejarme de Data Science, sino como llevar esa capacidad técnica más cerca de la decisión de negocio. Trabajando en áreas de negocio he visto un cambio muy claro en los últimos años: con la inteligencia artificial, analytics y automatización, equipos que antes estaban mucho más limitados ahora pueden descubrir nuevas herramientas, optimizar procesos por sí mismos y colaborar de forma mucho más estrecha con IT. Esa evolución me interesa muchísimo porque es justo donde siento que mi perfil puede aportar más. Lo que más disfruto no es sólo analizar datos, sino entender el problema, encontrar una mejor forma de hacer las cosas y convertir tecnología y datos en una decisión o una mejora concreta. Por eso Growth me parece una evolución natural para mi carrera.',
        answerEn: 'I do not see it as moving away from Data Science. I see it as bringing that technical capability closer to business decision-making. From working in business-oriented teams, I have seen a very clear shift in the last few years: with AI, analytics and automation, teams that used to be much more limited can now discover new tools, optimise processes themselves and work much more closely with IT. That evolution is very interesting to me because it is exactly where I feel my profile can add the most value. What I enjoy most is not only analysing data, but understanding the problem, finding a better way of doing things and turning technology and data into a concrete decision or improvement. That is why Growth feels like a natural direction for my career.'
      },
      {
      ...
      },
      {
        ...
        answerEs: 'Busco un rol analítico orientado a negocio, en esa intersección entre datos, tecnología y toma de decisiones. Es donde más me ha gustado trabajar y también donde estoy viendo una evolución más fuerte con la llegada de la IA. Cada vez hay más herramientas que permiten a los equipos de negocio automatizar, analizar y optimizar procesos sin estar tan separados de IT, y me gustaría desarrollarme justo en ese espacio. Quiero mantener una base técnica fuerte, pero utilizarla para entender problemas, priorizar oportunidades y generar impacto medible, ganando progresivamente más ownership sobre proyectos y resultados.',
        answerEn: 'I am looking for an analytical, business-oriented role at the intersection of data, technology and decision-making. That is where I have enjoyed working the most, and it is also where I see a lot of change happening because of AI. Business teams now have many more tools to automate, analyse and optimise processes without being so disconnected from IT, and that is exactly the space in which I want to develop. I want to keep a strong technical foundation, but use it to understand problems, prioritise opportunities and create measurable impact while gradually taking more ownership of projects and outcomes.'
      },
      {
        id: 'fever-five-years',
        category: 'Career direction',
