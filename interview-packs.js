    ...
    questions: [
      {
        ...
        answerEs: '1. Por qué Fever\nFever representa justo el tipo de entorno que busco: tecnología, datos y entretenimiento en un producto muy cercano al usuario. Además, su presencia internacional y el tipo de negocio me parecen una muy buena oportunidad para aplicar mi perfil técnico en un contexto dinámico y con impacto visible.\n\n2. Por qué este programa\nEl Growth Graduate Program me atrae porque combina análisis, estrategia y ejecución. No quiero quedarme sólo en analizar una métrica o construir un modelo; me interesa entender qué oportunidad hay detrás, qué decisión se toma y qué impacto tiene después.\n\n3. Conexión conmigo\nPor mi experiencia en ASISA y PHCA, sé que disfruto especialmente cuando puedo utilizar datos y tecnología para resolver problemas reales y apoyar decisiones, así que creo que este rol encaja de forma bastante natural conmigo.',
