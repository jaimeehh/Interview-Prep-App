    ...
    questions: [
      {
        ...
        answerEs: 'Me interesa IBM por tres motivos principales.\n\n1. Tecnología, datos e innovación\nIBM es una compañía muy ligada a tecnología, Data, AI y Cloud, y eso encaja directamente con lo que quiero seguir desarrollando. Me atrae especialmente poder trabajar en un entorno donde la innovación tecnológica forma parte del día a día y se aplica a problemas reales.\n\n2. Escala internacional y aprendizaje\nTambién me gusta mucho la dimensión internacional y la posibilidad de trabajar con gente que lleva años en este sector. En un programa como Early Associates, para mí lo primero sería escuchar, aprender y entender bien cómo se trabaja en proyectos reales, pero también intentar aportar valor desde el primer momento con mi base técnica y mi experiencia previa.\n\n3. Por qué Hybrid Cloud & Data\nDentro del programa, Hybrid Cloud & Data es el área que más me interesa porque se alinea directamente con mi perfil de Data Science, Analytics, automatización e IA. Además, me interesa entender mejor cómo las soluciones de datos e IA pasan de un análisis o un prototipo a algo que realmente se despliega, escala y utiliza dentro de una organización.\n\nPor eso IBM me parece una muy buena oportunidad para seguir creciendo técnicamente, aprender de perfiles con mucha experiencia y trabajar en problemas de mayor escala.',
        answerEn: 'I am interested in IBM for three main reasons.\n\n1. Technology, data and innovation\nIBM is a company strongly connected to technology, Data, AI and Cloud, and that fits directly with what I want to keep developing. I am especially attracted by the opportunity to work in an environment where technological innovation is part of the day-to-day work and is applied to real problems.\n\n2. International scale and learning\nI also really like the international dimension and the opportunity to work with people who have many years of experience in the sector. In a programme like Early Associates, my first priority would be to listen, learn and understand how real projects are approached, while also trying to add value from the beginning with my technical background and previous experience.\n\n3. Why Hybrid Cloud & Data\nWithin the programme, Hybrid Cloud & Data is the area that interests me most because it aligns directly with my background in Data Science, Analytics, automation and AI. I also want to understand better how data and AI solutions move from analysis or prototype to something that is actually deployed, scaled and used within an organisation.\n\nThat is why I see IBM as a very strong opportunity to keep growing technically, learn from experienced professionals and work on larger-scale problems.'
      },
      {
