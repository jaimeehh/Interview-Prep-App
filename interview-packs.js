    ...
    questions: [
      {
        ...
        answerEs: 'Me interesa IBM por tres motivos principales.\n\n1. Por qué IBM\nPara mí IBM representa tecnología, inteligencia artificial y desarrollo de soluciones a gran escala, que es justo hacia donde quiero orientar mi carrera. También me atrae mucho su dimensión internacional y la posibilidad de trabajar en proyectos donde la innovación tecnológica forma parte del día a día y se utiliza para resolver problemas reales.\n\n2. Por qué este programa y estas áreas\nEl Early Associates Program me interesa porque me permitiría aprender cómo se trabaja de verdad en proyectos complejos: escuchar, entender el workflow, aprender de gente con más experiencia y, al mismo tiempo, ir aportando valor desde el principio con mi base técnica.\n\nMi primera opción es Hybrid Cloud & Data porque encaja directamente con mi perfil de Data Science, Analytics, automatización e IA. Me interesa especialmente entender cómo las soluciones pasan de un análisis o un prototipo a algo que se despliega, escala y se utiliza de verdad en una organización. Creo que IBM, por su experiencia y escala tecnológica, puede darme mucha exposición y aprendizaje en esa parte.\n\nStrategy & Transformation sería mi segunda opción porque también me interesa mucho la parte de management y negocio. Ya he trabajado cerca de estrategia interna y me gusta entender cómo una solución técnica termina cambiando una decisión, un proceso o una forma de trabajar. Además, creo que con la evolución de la IA esa conexión entre tecnología y negocio va a ser cada vez más importante.\n\n3. Por qué encaja conmigo\nEn ASISA utilicé datos para apoyar decisiones de dirección y en PHCA trabajé con analytics, automatización e IA aplicada a procesos. Esas experiencias me han confirmado que quiero seguir creciendo en Data/AI, pero sin perder de vista el impacto real de lo que hago. Por eso IBM me parece un entorno muy completo para seguir desarrollándome.',
        answerEn: 'I am interested in IBM for three main reasons.\n\n1. Why IBM\nFor me, IBM represents technology, artificial intelligence and the development of solutions at scale, which is exactly the direction in which I want to take my career. I am also very attracted by its international dimension and the opportunity to work on projects where technological innovation is part of the day-to-day work and is used to solve real problems.\n\n2. Why this programme and these areas\nThe Early Associates Program interests me because it would allow me to learn how complex projects are actually approached: listening, understanding the workflow, learning from people with more experience and, at the same time, adding value from the beginning with my technical background.\n\nMy first choice is Hybrid Cloud & Data because it aligns directly with my background in Data Science, Analytics, automation and AI. I am especially interested in understanding how solutions move from analysis or prototype to something that is deployed, scaled and actually used within an organisation. I think IBM\'s experience and technological scale can give me strong exposure and learning in that area.\n\nStrategy & Transformation would be my second choice because I am also very interested in the management and business side. I have already worked close to internal strategy and I enjoy understanding how a technical solution eventually changes a decision, a process or a way of working. I also think that, as AI evolves, the connection between technology and business will become increasingly important.\n\n3. Why it fits me\nAt ASISA, I used data to support management decisions, and at PHCA I worked with analytics, automation and applied AI. Those experiences have confirmed that I want to keep growing in Data/AI without losing sight of the real impact of what I do. That is why IBM feels like a very complete environment for my development.'
      },
      {
