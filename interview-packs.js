    ...
    questions: [
      {
        ...
        answerEs: 'Me atrae Fever por la combinación de entretenimiento, tecnología y datos. No es sólo una plataforma para vender entradas: el producto está muy ligado a descubrir experiencias, entender qué funciona en cada mercado y ayudar a que esas experiencias crezcan. Eso me parece especialmente interesante porque el resultado es muy tangible y cercano al usuario. Además, me gusta que Growth tenga un papel muy conectado con estrategia y ejecución, utilizando datos para tomar decisiones sobre mercados, partners y rendimiento. A nivel personal, es un tipo de entorno que encaja con lo que quiero desarrollar: estar cerca del negocio, pero usando herramientas analíticas y tecnológicas para decidir mejor. He trabajado en contextos como ASISA y PHCA donde esa conexión entre datos y negocio era importante, y me gustaría seguir creciendo en una empresa donde esa forma de trabajar está en el centro del modelo.',
        answerEn: 'What attracts me to Fever is the combination of entertainment, technology and data. It is not just a ticketing platform: the product is closely linked to discovering experiences, understanding what works in each market and helping those experiences grow. I find that especially interesting because the outcome is very tangible and close to the customer. I also like the fact that Growth seems very connected to both strategy and execution, using data to make decisions about markets, partners and performance. Personally, that is exactly the kind of environment in which I want to develop: close to the business, but using analytical and technological tools to make better decisions. I have worked in environments such as ASISA and PHCA where that connection between data and business was important, and I would like to keep growing in a company where that way of working is central to the business model.'
      },
      {
        ...
        answerEs: 'Me interesa Growth porque combina análisis con decisiones de negocio y ejecución. Lo que más me atrae no es quedarme únicamente en entender qué está pasando, sino utilizar esa información para decidir qué mercado priorizar, qué experiencia potenciar, qué palanca mover y luego medir si realmente ha funcionado. En Fever eso además ocurre dentro de un negocio muy dinámico, con muchos mercados, tipos de experiencias y partners, por lo que el aprendizaje puede ser muy rápido. El Graduate Program me parece especialmente atractivo porque me permitiría aprender ese proceso de principio a fin con responsabilidad real. Mi experiencia en ASISA me hizo ver que disfruto cuando el análisis termina influyendo en una decisión, y en PHCA reforcé esa idea trabajando con automatización e IA aplicada a procesos de negocio. Por eso Growth encaja muy bien con la dirección en la que quiero desarrollar mi carrera.',
        answerEn: 'I am interested in Growth because it combines analysis with business decisions and execution. What attracts me most is not stopping at understanding what is happening, but using that information to decide which market to prioritise, which experience to push, which lever to move and then measuring whether it actually worked. At Fever, that also happens in a very dynamic business with many markets, types of experiences and partners, so I think the learning curve can be very steep. The Graduate Program is especially attractive because it would let me learn that end-to-end process with real responsibility. My experience at ASISA showed me that I enjoy seeing analysis influence a real decision, and at PHCA I reinforced that interest by working with automation and AI applied to business processes. That is why Growth fits very well with the direction in which I want to develop my career.'
      },
      {
