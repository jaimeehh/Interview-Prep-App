    ...
    questions: [
      {
        ...
        answerEs: '1. Por qué IBM\nMe atrae IBM por su peso tecnológico y porque trabaja en áreas que encajan mucho con mi perfil, como Data, AI, Analytics y Cloud. Además, me gusta que sean tecnologías aplicadas a proyectos reales y a problemas complejos de empresas, porque es justo donde creo que más puedo aprender y aportar.\n\n2. Por qué este programa y estas áreas\nEl Early Associates Program me interesa porque me permitiría empezar en proyectos reales, aprender de equipos distintos y conocer varias áreas antes de especializarme demasiado pronto. Mi primera opción es Hybrid Cloud & Data porque conecta directamente con Data Science, Analytics, automatización e IA; y también me interesa entender mejor cómo cloud permite desplegar y escalar esas soluciones. Strategy & Transformation sería mi segunda opción porque me interesa ver cómo una solución técnica acaba cambiando procesos y decisiones.\n\n3. Por qué encaja conmigo\nEn ASISA utilicé datos para apoyar decisiones de dirección y en PHCA trabajé con analytics, automatización e IA aplicada a procesos. Esas experiencias me han confirmado que quiero seguir creciendo en Data/AI, pero sin perder de vista para qué sirve la solución y qué impacto genera. Por eso IBM me parece un entorno muy fuerte para seguir desarrollándome.',
        answerEn: '1. Why IBM\nIBM attracts me because of its strong technology focus and because it works in areas that fit very well with my profile, such as Data, AI, Analytics and Cloud. I also like that these technologies are applied to real projects and complex business problems, because that is exactly where I think I can learn the most and contribute.\n\n2. Why this programme and these areas\nThe Early Associates Program interests me because it would let me start on real projects, learn from different teams and explore several areas before specialising too early. My first choice is Hybrid Cloud & Data because it connects directly with Data Science, Analytics, automation and AI, and I also want to understand better how cloud enables those solutions to be deployed and scaled. Strategy & Transformation would be my second choice because I am interested in seeing how a technical solution eventually changes processes and decisions.\n\n3. Why it fits me\nAt ASISA, I used data to support management decisions, and at PHCA I worked with analytics, automation and applied AI. Those experiences have confirmed that I want to keep growing in Data/AI without losing sight of what the solution is for and what impact it creates. That is why IBM feels like a very strong environment for my development.'
      },
      {
